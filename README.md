...
generalize.
The benchmark uses one 512-token reference prefill depth, so served samples
deeper than the comparable depth remain recorded but are not used as planning
evidence.
