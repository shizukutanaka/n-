...
MESSAGES = {
    "en": {
        ...
        "label.orchestrate_verifier": "verifier: accuracy={accuracy:.4f}, accepted={accepted}, accepted-but-wrong={wrong}, rejected-but-right={right}, unparsed={unparsed}, confidence={confidence}",
...
MESSAGES["ja"].update({
    ...
    "label.orchestrate_verifier": "\u691c\u8a3c\u5668: \u6b63\u78ba\u5ea6={accuracy:.4f}, \u53d7\u7406={accepted}, \u8aa4\u53d7\u7406={wrong}, \u6b63\u7b54\u5374\u4e0b={right}, \u672a\u89e3\u6790={unparsed}, \u4fe1\u8d74\u5ea6={confidence}",
