...
MESSAGES = {
    "en": {
        ...
        "note.eval_divergence": "{config}: pass rate {other_rate} there vs {rate} here, yet the two configurations disagree on {count} of {compared} tasks ({ids}). Measured here: two fp16 configurations of Qwen2.5 0.5B both scored 9/16 while disagreeing on 2 tasks in opposite directions, so an equal pass rate does not mean equivalent behaviour.",
...
MESSAGES["ja"].update({
    ...
    "note.eval_divergence": "{config}: \u305d\u306e\u69cb\u6210\u306e\u5408\u683c\u7387\u306f {other_rate}\u3001\u3053\u3061\u3089\u306f {rate}\u3067\u3059\u304c\u3001\u4e21\u69cb\u6210\u306f {compared}\u554f\u4e2d {count}\u554f\u306e\u5224\u5b9a\u304c\u4e00\u81f4\u3057\u307e\u305b\u3093\uff08{ids}\uff09\u3002\u5b9f\u6e2c\u3067\u306f Qwen2.5 0.5B \u306e\u540c\u3058 fp16 \u69cb\u6210\u304c\u4e21\u65b9\u3068\u3082 9/16 \u3067\u3042\u308a\u306a\u304c\u3089 2\u554f\u3067\u9006\u65b9\u5411\u306b\u98df\u3044\u9055\u3044\u3001\u5408\u683c\u7387\u304c\u540c\u3058\u3067\u3082\u6319\u52d5\u304c\u540c\u7b49\u3068\u306f\u9650\u308a\u307e\u305b\u3093\u3002",
