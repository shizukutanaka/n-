...
MESSAGES = {
    "en": {
        ...
        "models.fetch_unknown": "Unknown catalog model id: {model}",
        "models.fetch_not_planned": "No planned service for {model} on this hardware",
        "models.fetch_failed": "Model fetch failed: {error}",
        "models.fetched": "Fetched {model} ({backend}, {quant}): {ref}",
    ...
    "ja": {
        ...
        "models.fetch_unknown": "カタログに無いモデルID: {model}",
        "models.fetch_not_planned": "このハードウェアでは {model} の配置プランを生成できませんでした",
        "models.fetch_failed": "モデルの取得に失敗しました: {error}",
        "models.fetched": "{model} を取得しました（{backend}、{quant}）: {ref}",
