...
MESSAGES = {
    "en": {
        ...
        "label.cpu": "CPU",
        "label.tier": "Tier",
        "label.gpu_vram": "GPU {index} VRAM",
        "label.free_budget_vram": "Free budget VRAM",
        "label.free_budget_ram": "Free budget RAM",
    ...
    "warn.plan_stale": "保存済みのプランは古い nmesh で生成されました（起動フラグの仕様が変更されています）。最新の改善を取り込むには `nmesh plan` を再実行してください。",
        ...
        "label.tier": "ティア",
        "label.gpu_vram": "GPU {index} VRAM",
        "label.free_budget_vram": "空き予算 VRAM",
        "label.free_budget_ram": "空き予算 RAM",
        "label.none": "なし",
