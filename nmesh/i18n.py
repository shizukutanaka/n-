...
MESSAGES = {
    "en": {
        ...
        "hint.language": "Locale is {locale}; use --lang {language} to prioritize models claiming {language}.",
        ...
        "err.autotune_up": "Service is not running; run nmesh up first.",
        "err.autotune_measure": "Autotune failed: {error}",
        "err.no_plan_found": "No plan found",
        "err.unknown_service_key": "Unknown service: {service}",
        "label.item": "Item",
        "label.value": "Value",
        "label.free": "free",
        "label.none": "none",
    ...
    "ja": {
        ...
        "hint.language": "ロケールは{locale}です。{language}対応を主張するモデルを優先するには --lang {language} を使用してください。",
        ...
        "err.autotune_up": "サービスが起動していません。先にnmesh upを実行してください。",
        "err.autotune_measure": "自動調整に失敗しました: {error}",
        "err.no_plan_found": "プランが見つかりません",
        "err.unknown_service_key": "不明なサービス: {service}",
        "label.item": "項目",
        "label.value": "値",
        "label.free": "空き",
        "label.none": "なし",
