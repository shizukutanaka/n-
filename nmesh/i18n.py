...
MESSAGES = {
    "en": {
        ...
        "note.ollama_max_loaded": "{service}: pinned OLLAMA_MAX_LOADED_MODELS={limit} on the shared ollama daemon — it can hold at most the {limit} model(s) this plan runs concurrently (resident members plus one swap slot). Set the variable yourself to override.",
...
MESSAGES["ja"].update({
    ...
    "note.ollama_max_loaded": "{service}: \u5171\u6709 ollama \u30c7\u30fc\u30e2\u30f3\u306b OLLAMA_MAX_LOADED_MODELS={limit} \u3092\u8a2d\u5b9a\u3057\u307e\u3057\u305f \u2014 \u30d7\u30e9\u30f3\u304c\u540c\u6642\u306b\u8d70\u3089\u305b\u308b\u30e2\u30c7\u30eb\u6570\uff08\u5e38\u99d0\u30e1\u30f3\u30d0\u30fc + \u30b9\u30ef\u30c3\u30d7 1 \u30b9\u30ed\u30c3\u30c8\uff09\u3092\u8d8a\u3048\u3066\u30ed\u30fc\u30c9\u4fdd\u6301\u3057\u306a\u3044\u3088\u3046\u306b\u3057\u307e\u3059\u3002\u4e0a\u66f8\u304d\u3059\u308b\u306b\u306f\u540c\u74b0\u5883\u5909\u6570\u3092\u8a2d\u5b9a\u3057\u3066\u304f\u3060\u3055\u3044\u3002",
