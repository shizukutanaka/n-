...
MESSAGES = {
    "en": {
        ...
        "note.ollama_models_dir": "The ollama daemon will store model weights under {path} (inside NMESH_HOME); set OLLAMA_MODELS in the environment to keep using the system store.",
...
MESSAGES["ja"].update({
    ...
    "note.gpu_pinned": "{service}: GPU {indices} \u306b\u30d4\u30f3\u7559\u3081\u3057\u307e\u3057\u305f\uff08\u63a8\u5b9a\u914d\u7f6e\u30fb\u30c7\u30d0\u30a4\u30b9\u53ef\u8996\u6027\u3067\u5206\u96e2\uff09",
        "note.ollama_models_dir": "ollama \u30c7\u30fc\u30e2\u30f3\u306e\u30e2\u30c7\u30eb\u91cd\u307f\u306f {path}\uff08NMESH_HOME \u5185\uff09\u306b\u4fdd\u5b58\u3055\u308c\u307e\u3059\u3002\u30b7\u30b9\u30c6\u30e0\u306e\u65e2\u5b58\u30b9\u30c8\u30a2\u3092\u4f7f\u3044\u7d9a\u3051\u308b\u306b\u306f\u74b0\u5883\u5909\u6570 OLLAMA_MODELS \u3092\u8a2d\u5b9a\u3057\u3066\u304f\u3060\u3055\u3044\u3002",
