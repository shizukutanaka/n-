...
MESSAGES = {
    "en": {
        ...
        "note.ollama_keep_alive": "{service}: OLLAMA_KEEP_ALIVE=-1 so the resident model stays loaded (the daemon default would unload it after ~5 minutes idle).",
...
MESSAGES["ja"].update({
    ...
    "note.ollama_keep_alive": "{service}: OLLAMA_KEEP_ALIVE=-1 \u3092\u8a2d\u5b9a\u3057\u3001\u5e38\u99d0\u30e2\u30c7\u30eb\u3092\u30ed\u30fc\u30c9\u72b6\u614b\u306b\u4fdd\u3061\u307e\u3059\uff08\u30c7\u30fc\u30e2\u30f3\u65e2\u5b9a\u3067\u306f\u7d045\u5206\u306e\u30a2\u30a4\u30c9\u30eb\u3067\u30a2\u30f3\u30ed\u30fc\u30c9\u3055\u308c\u307e\u3059\uff09\u3002",
