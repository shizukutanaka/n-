...
MESSAGES = {
    "en": {
        ...
        "evidence.reason.stale_digest": "the stored retrieval measurement used stale workload rules",
        "evidence.reason.unmeasured": "the retrieval ladder did not measure a degradation point",
...
MESSAGES["ja"].update({
    ...
    "evidence.reason.stale_digest": "古いワークロード規則で測定された検索記録です",
    "evidence.reason.unmeasured": "検索ラダーで劣化点が測定できませんでした",
