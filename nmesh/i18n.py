...
MESSAGES = {
    "en": {
        ...
        "err.model_not_found": "model not found: {name}",
        "err.model_remove": "unable to remove model: {error}",
        "label.decision": "decision: {decision} ({reason})",
    ...
    "ja": {
        ...
        "err.model_not_found": "モデルが見つかりません: {name}",
        "err.model_remove": "モデルを削除できません: {error}",
        "label.decision": "判定: {decision}（{reason}）",
