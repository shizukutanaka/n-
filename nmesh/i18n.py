...
MESSAGES = {
    "en": {
        ...
        "warn.plan_hardware_drift": "Hardware changed since the saved plan was built: {changes}. Re-run `nmesh plan` to re-fit, or the plan's placements may fail.",
    ...
    "warn.plan_hardware_drift": "保存済みプラン生成時からハードウェアが変化しています: {changes}。`nmesh plan` で再計画しないと、プランの配置に失敗する可能性があります。",
