...
MESSAGES = {
    "en": {
        ...
        "err.unload_not_owned": "{service} was not unloaded: nmesh will not stop a running process it does not own; use nmesh down --foreign.",
    ...
    "ja": {
        ...
        "err.unload_not_owned": "{service} をアンロードしませんでした: nmesh は自身が所有していない実行中プロセスを停止しません。nmesh down --foreign を使用してください。",
