...
MESSAGES = {
    "en": {
        ...
        "note.gpu_pinned_daemon": "shared daemon: pinned to GPU(s) {indices} (union of its services' planned GPUs; enforced via device visibility so it cannot take cards budgeted for other services)",
        "note.gpu_pinned_daemon_cpu": "shared daemon: GPU visibility disabled (its services are budgeted fully on RAM; enforced via device visibility so it cannot take cards budgeted for other services)",
...
MESSAGES["ja"].update({
    ...
    "note.gpu_pinned_daemon": "shared daemon: GPU {indices} \u306b\u30d4\u30f3\u7559\u3081\u3057\u307e\u3057\u305f\uff08\u30b5\u30fc\u30d3\u30b9\u8a08\u753b\u4e0a\u306e\u5272\u5f53 GPU \u306e\u548c\u96c6\u5408\u30fb\u30c7\u30d0\u30a4\u30b9\u53ef\u8996\u6027\u3067\u5206\u96e2\u3057\u4ed6\u30b5\u30fc\u30d3\u30b9\u4e88\u7b97\u306e\u30ab\u30fc\u30c9\u3092\u53d6\u3089\u305b\u307e\u305b\u3093\uff09",
    "note.gpu_pinned_daemon_cpu": "shared daemon: GPU \u53ef\u8996\u6027\u3092\u7121\u52b9\u306b\u3057\u307e\u3057\u305f\uff08\u30b5\u30fc\u30d3\u30b9\u306f\u5168\u91cf RAM \u4e88\u7b97\u30fb\u30c7\u30d0\u30a4\u30b9\u53ef\u8996\u6027\u3067\u5206\u96e2\u3057\u4ed6\u30b5\u30fc\u30d3\u30b9\u4e88\u7b97\u306e\u30ab\u30fc\u30c9\u3092\u53d6\u3089\u305b\u307e\u305b\u3093\uff09",
