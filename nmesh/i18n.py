...
MESSAGES = {
    "en": {
        ...
        "warn.context_shift_enabled": "{model}: context shift is enabled; when input exceeds the context window the oldest tokens are silently dropped.",
        ...
        "evidence.column.priority": "Priority",
        "evidence.column.action": "Action",
        "evidence.column.reason": "Reason",
        "evidence.column.confidence": "Confidence",
        "evidence.actions_title": "Recommended actions",
        "evidence.reason.no_measurements": "no measurements are recorded, so plans use catalog estimates",
    ...
    "ja": {
        ...
        "warn.context_shift_enabled": "{model}: コンテキストシフトが有効です。入力がコンテキスト窓を超えると最古のトークンが静かに捨てられます。",
...
MESSAGES["ja"].update({
    ...
    "evidence.column.priority": "優先度",
    "evidence.column.action": "操作",
    "evidence.column.reason": "理由",
    "evidence.column.confidence": "信頼度",
    "evidence.actions_title": "推奨アクション",
    "evidence.reason.no_measurements": "測定記録がないため、計画はカタログの推定値を使います",
