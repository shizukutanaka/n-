...
MESSAGES = {
    "en": {
        ...
        "err.models_root_not_dir": "model root is not an existing directory: {path}",
        "err.models_not_found": "model not found: {name}",
        "err.models_remove_failed": "unable to remove model: {error}",
        ...
        "warn.backend_version_unresponsive": "{backend}: binary at {path} did not answer `--version`; treating the backend as unavailable.",
        ...
        "warn.hf_hub_offline": "HF_HUB_OFFLINE/TRANSFORMERS_OFFLINE is set: huggingface_hub will refuse every planned download with OfflineModeIsEnabled at apply time.",
        "warn.hf_endpoint": "HF_ENDPOINT={endpoint} is set: planned downloads will fetch weights from this endpoint instead of huggingface.co.",
        ...
        "label.spec_decision": "decision: {decision} ({reason})",
        ...
        "warn.ollama_num_parallel_env": "OLLAMA_NUM_PARALLEL={parallel} is set in the environment; the shared Ollama daemon can commit up to {parallel} times the KV memory the plan accounts for.",
        ...
        "label.autostart_display": "Filename: {filename}\n\n{text}\nInstall with:\n{install_command}",
    ...
    "ja": {
        ...
        "warn.backend_version_unresponsive": "{backend}: {path} \u306e\u30d0\u30a4\u30ca\u30ea\u304c `--version` \u306b\u5fdc\u7b54\u3057\u306a\u304b\u3063\u305f\u305f\u3081\u3001\u30d0\u30c3\u30af\u30a8\u30f3\u30c9\u3092\u5229\u7528\u4e0d\u53ef\u3068\u3057\u3066\u6271\u3044\u307e\u3059\u3002",
        ...
        "err.models_root_not_dir": "モデルルートが存在しないディレクトリです: {path}",
        "err.models_not_found": "モデルが見つかりません: {name}",
        "err.models_remove_failed": "モデルを削除できません: {error}",
        ...
        "warn.hf_hub_offline": "HF_HUB_OFFLINE/TRANSFORMERS_OFFLINE が設定されています: huggingface_hub は適用時に計画済みダウンロードを全て OfflineModeIsEnabled で拒否します。",
        "warn.hf_endpoint": "HF_ENDPOINT={endpoint} が設定されています: 計画済みダウンロードは huggingface.co ではなくこのエンドポイントから重みを取得します。",
    ...
    "warn.plan_stale": "保存済みのプランは古い nmesh で生成されました（起動フラグの仕様が変更されています）。最新の改善を取り込むには `nmesh plan` を再実行してください。",
        ...
        "label.spec_decision": "判定: {decision} ({reason})",
        ...
        "warn.ollama_num_parallel_env": "環境に OLLAMA_NUM_PARALLEL={parallel} が設定されています。共有 Ollama デーモンは計画が見積もる KV メモリの最大 {parallel} 倍を確保し得ます。",
...
MESSAGES["ja"].update({
    ...
    "label.autostart_display": "\u30d5\u30a1\u30a4\u30eb\u540d: {filename}\n\n{text}\n\u30a4\u30f3\u30b9\u30c8\u30fc\u30eb\u65b9\u6cd5:\n{install_command}",
