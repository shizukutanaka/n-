...
MESSAGES = {
    "en": {
        ...
        "warn.disk_low": "Low disk space under {path}: only {free} free. Model artifacts are several GB each; free space before nmesh up.",
    ...
    "warn.plan_stale": "保存済みのプランは古い nmesh で生成されました（起動フラグの仕様が変更されています）。最新の改善を取り込むには `nmesh plan` を再実行してください。",
        ...
        "warn.disk_low": "{path} のディスク空きが残り {free} しかありません。モデルは1件数GBあるため、nmesh up 前に空きを確保してください。",
