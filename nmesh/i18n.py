...
MESSAGES = {
    "en": {
        ...
        "install.llamacpp": "Install llama.cpp with nmesh engine install, or {tools}",
        "install.llamacpp.tools_windows": "use winget or build from source",
        "install.llamacpp.tools_macos": "use brew or build from source",
        "install.llamacpp.tools_linux": "build from source",
    ...
    "ja": {
        ...
        "install.llamacpp": "nmesh engine install で llama.cpp をインストールできます。{tools}",
        "install.llamacpp.tools_windows": "winget またはソースからのビルドも利用できます",
        "install.llamacpp.tools_macos": "brew またはソースからのビルドも利用できます",
        "install.llamacpp.tools_linux": "ソースからのビルドも利用できます",
