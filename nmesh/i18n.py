...
MESSAGES = {
    "en": {
        ...
        "warn.kv_offload_unsupported": "{model}: this llama.cpp build lacks --no-kv-offload; the KV cache stays on the GPU instead of host RAM.",
    ...
    "ja": {
        ...
        "warn.kv_offload_unsupported": "{model}: この llama.cpp ビルドは --no-kv-offload 非対応のため、KV キャッシュはホスト RAM ではなく GPU に留まります。",
