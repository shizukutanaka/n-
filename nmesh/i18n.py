...
MESSAGES = {
    "en": {
        ...
        "warn.jinja_unsupported": "{model}: llama.cpp --jinja is unsupported; the model's chat template may not be applied.",
    ...
    "ja": {
        ...
        "warn.jinja_unsupported": "{model}: llama.cpp --jinja に未対応のため、モデルのチャットテンプレートが適用されない可能性があります。",
