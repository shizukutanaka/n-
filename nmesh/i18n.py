...
MESSAGES = {
    "en": {
        ...
        "label.eval_context_control": "Context probe controls: {passed}/{total}; attributable: {attributable}",
...
MESSAGES["ja"].update({
    ...
    "label.eval_context_control": "\u6587\u8108\u30d7\u30ed\u30fc\u30d6\u30b3\u30f3\u30c8\u30ed\u30fc\u30eb: {passed}/{total}\u3001\u6df1\u5ea6\u306e\u5224\u5b9a\u53ef\u80fd: {attributable}",
