...
MESSAGES = {
    ...
    "ja": {
        ...
        "models.local": "nmesh ???????",
        "err.unload_not_running": "{service} ??????????????: ??????????",
        "err.unload_idle": "{service} ??????????????: ????????????",
        "err.unload_shared": "{service} ??????????????: ??????? nmesh ????????",
        "err.unload_external": "{service} ??????????????: nmesh ???????????????????????????",
        "err.unload_not_owned": "{service} ??????????????: nmesh ??????????????????????????????? nmesh down --foreign ???????",
        "err.unload_unknown": "{service} ???????????????",
