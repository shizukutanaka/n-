...
MESSAGES = {
    "en": {
        ...
        "warn.plan_backend_missing": "Saved plan: {service} requires backend '{backend}' but it was not found on this machine — install it or replan (nmesh plan).",
        "warn.plan_port_in_use": "Saved plan: port {port} for {service} is already bound by another process — free it or replan.",
    ...
    "warn.plan_stale": "保存済みのプランは古い nmesh で生成されました（起動フラグの仕様が変更されています）。最新の改善を取り込むには `nmesh plan` を再実行してください。",
        ...
        "warn.plan_backend_missing": "\u4fdd\u5b58\u6e08\u307f\u30d7\u30e9\u30f3: {service} \u306f\u30d0\u30c3\u30af\u30a8\u30f3\u30c9 '{backend}' \u3092\u5fc5\u8981\u3068\u3057\u307e\u3059\u304c\u898b\u3064\u304b\u308a\u307e\u305b\u3093 \u2014 \u30a4\u30f3\u30b9\u30c8\u30fc\u30eb\u3059\u308b\u304b\u518d\u30d7\u30e9\u30f3\uff08nmesh plan\uff09\u3057\u3066\u304f\u3060\u3055\u3044\u3002",
        "warn.plan_port_in_use": "\u4fdd\u5b58\u6e08\u307f\u30d7\u30e9\u30f3: {service} \u306e\u30dd\u30fc\u30c8 {port} \u306f\u5225\u30d7\u30ed\u30bb\u30b9\u304c\u4f7f\u7528\u4e2d\u3067\u3059 \u2014 \u89e3\u653e\u3059\u308b\u304b\u518d\u30d7\u30e9\u30f3\u3057\u3066\u304f\u3060\u3055\u3044\u3002",
