...
MESSAGES = {
    "en": {
        ...
        "warn.bench_epoch": "Benchmark measured while the host was at {ratio:.0%} of its best observed reference speed; the previous value was kept.",
...
MESSAGES["ja"].update({
    ...
    "warn.bench_epoch": "ホストが過去に観測した基準速度の {ratio:.0%} の状態で測定されたため、以前の値を保持しました。",
