...
MESSAGES = {
    "en": {
        ...
        "warn.mlock_unsupported": "{model}: this llama.cpp build lacks --mlock; resident weights may still be paged out under memory pressure.",
    ...
    "ja": {
        ...
        "warn.mlock_unsupported": "{model}: この llama.cpp ビルドは --mlock に対応していないため、常駐重みがメモリ逼迫時にページアウトされる可能性があります。",
